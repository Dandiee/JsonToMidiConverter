...
public static class Dumper
{
    ...
    public static void DumpBeforeBuild(List<DataPart> parts, MidiFile midi, Record record, bool overwrite)
    {
        WriteRawJsons(record);
        //WriteMinifiedMidiInputJson(parts, record, overwrite);
        WriteRawMidiData(midi, record, overwrite);
        WriteMeasuredMidiData(midi, record, overwrite);
    ...
    private static void WriteMeasuredMidiData(MidiFile midi, Record record, bool overwrite)
    {
