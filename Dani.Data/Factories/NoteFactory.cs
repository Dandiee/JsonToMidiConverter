...
using Bend = Dani.Data.Models.Parts.Bend;
using Note = Dani.Data.Models.Parts.Note;

namespace Dani.Data.Factories;
public static class NoteFactory
{

    public static readonly float[] HarmonicFretTable =
    [
